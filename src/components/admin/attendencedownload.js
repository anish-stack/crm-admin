...
const Attendencedownload = () => {
    ...
    const handleDownloadClick = () => {
        axios
          .get('https://crmbackend-tawny.vercel.app/downloadAllAttendance', {
          ...
          .then((response) => {
            ...
            if (response.data) {
              ...
              downloadLink.download = 'AttendanceData.xlsx'; // Set the filename for the download
          ...
          .catch((error) => {
            ...
            Swal.fire({
              icon: 'error',
              title: 'Error',
              text: 'An error occurred while downloading attendance data.',
            });
          });
      };
...
export default Attendencedownload